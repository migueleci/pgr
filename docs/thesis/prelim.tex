...
%Secci\'on: Ret\'iculo Algebraico Completo
\section{\textit{SMT-Solving}}
\label{smt.prelim}

\begin{enumerate}
\item Qu\'e es SMT-Solving y su relaci\'on con procedimientos de decisi\'on.
\item Qu\'e es un SMT-Solver
\item Maude, en sus versiones mas recientes utiliza CVC4 como SMT-Solver suministrando funcionalidades para reescritura. M\'odulo SMT [citar articulo de camilo JLAMP 2017].
\item En este trabajo se usan procedimientos de decisi\'on y semi-decisi\'on sobre los enteros para codificar un sistema de restricciones sobre enteros.
\end{enumerate}
